...
GADTNativeTemplateStyleKey const GADTNativeTemplateStyleKeyCallToActionBorderColor = @"border_color";
...
- (instancetype)initWithFrame:(CGRect)frame {
  if (self = [super initWithFrame:frame]) {
      ...
      NSString *path = [[NSBundle mainBundle] pathForResource:@"XMAdBundle" ofType:@"bundle"];
    ...
    _rootView = [bundle loadNibNamed:NSStringFromClass([self class])
                                            owner:self
                                          options:nil]
                    .firstObject;
...
//  self.layer.borderWidth = 1.0f;
  ...
  if ([self styleForKey:GADTNativeTemplateStyleKeyCornerRadius]) {
    ...
    if ([self styleForKey:GADTNativeTemplateStyleKeyCallToActionBorderColor]) {
        UIColor *cl = [self styleForKey:GADTNativeTemplateStyleKeyCallToActionBorderColor];
        ((UIButton*)self.callToActionView).layer.borderColor = cl.CGColor;
        ((UIButton*)self.callToActionView).layer.borderWidth = 1;
    }
  // Fonts
